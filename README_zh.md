...
| 插件 | 描述 | 作者 |
|------|------|------|
| [fleet-action](https://github.com/Jerry-Scicintilla/fleet-action) | 舰队 PAP（考勤）管理，支持手动考勤记录 | Jerry_Scintilla |
| [helm-mcp](https://github.com/Jerry-Scicintilla/helm-plugin-MCP) | Model Context Protocol 服务器，向 LLM 暴露 Helm 功能 | Jerry_Scintilla |
