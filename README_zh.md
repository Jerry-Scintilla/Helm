...
| 插件 | 描述 | 作者 |
|------|------|------|
| [fleet-action](https://github.com/Jerry-Scintilla/helm-plugin-fleet-action) | 舰队 PAP（考勤）管理，支持手动考勤记录 | Jerry_Scintilla |
| [SRP](https://github.com/Jerry-Scintilla/helm-plugin-SRP) | 舰船补损管理系统，支持 killmails 链接解析、补损官审核和价格配置 | Jerry_Scintilla |
| [helm-mcp](https://github.com/Jerry-Scintilla/helm-plugin-MCP) | Model Context Protocol 服务器，向 LLM 暴露 Helm 功能 | Jerry_Scintilla |
...
详见 [Markdown/Plugin_Dev_Guide/](Markdown/Plugin_Dev_Guide/) 中的完整插件开发指南。
...
- [Helm 文档](https://jerry-scintilla.github.io/Helm-screenshot/)
- [插件开发指南](Markdown/Plugin_Dev_Guide/)
