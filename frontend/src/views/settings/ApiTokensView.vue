...
<template>
  <div class="settings-page">
    <div class="page-header">
      <h1 class="page-title h-serif">{{ t('settings.tokens.title') }}</h1>
...
.page-title { font-size: 1.5rem; color: #faf9f5; margin: 0 0 4px; }
.page-subtitle { font-size: 0.85rem; color: #87867f; margin: 0; }
.token-value {
